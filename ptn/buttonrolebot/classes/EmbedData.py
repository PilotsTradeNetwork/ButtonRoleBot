...
from ptn.buttonrolebot.constants import DEFAULT_EMBED_DESC, EMBED_COLOUR_PTN_DEFAULT
...
class EmbedData:
    ...
    def __str__(self):
        ...
        """
        return (
            "EmbedData: embed_title:{0.embed_title} | embed_description:{0.embed_description} | "
